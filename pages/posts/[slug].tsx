...
const PostPage = ({ post }) => {
  ...
  return <>
    ...
    <div id="single-post">
      ...
      <div id="post-header">
        <img id='post-image' src={`${CDN_URL}${post.thumbnail}`} alt={post.title} />
      ...
      <div id="post-content">
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<p class='post-summary'>${post.summary || ''}</p> ${post.htmlContent || ''}` }}
        ></div>
      </div>
